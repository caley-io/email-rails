...
- Before contributing, please check if it already exists in [issues](https://github.com/caley-io/caley/issues) or [PRs](https://github.com/caley-io/caley/pulls)
...
As we are still in the early days of this project, we recommend [heading over to the Wiki](https://github.com/caley-io/caley/wiki) to get a better idea of _what_ to contribute.

In general, _full features_ that get us closer to [our Vision](https://github.com/caley-io/caley/wiki/Vision) are the most valuable contributions at this stage.
...
2. Local Development
   - [Mac Setup Guide](https://github.com/caley-io/caley/wiki/Mac-Dev-Setup-Guide)
   - [Linux Setup Guide](https://github.com/caley-io/caley/wiki/Linux-Dev-Setup-Guide)
   - [Windows Setup Guide](https://github.com/caley-io/caley/wiki/Windows-Dev-Setup-Guide)
